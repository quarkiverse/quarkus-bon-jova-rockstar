...
public class ParseHelper {
    ...
    public Rockstar.ExpressionContext getExpression(String program, int expressionPosition) {
        return (Rockstar.ExpressionContext) getGrammarElement(program,
                (CapturingListener l) -> l.getExpression(expressionPosition));
    }
    ...
    private RuleContext getGrammarElement(String program, Function<CapturingListener, RuleContext> getter) {
        /*
