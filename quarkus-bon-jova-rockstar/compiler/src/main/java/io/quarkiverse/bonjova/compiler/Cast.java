...
public class Cast {
    private static final MethodDescriptor VALUE_OF_METHOD = MethodDescriptor.ofMethod(Double.class, "valueOf", Double.class,
            String.class);
    private static final MethodDescriptor DOUBLE_FROM_INTEGER_METHOD = MethodDescriptor.ofMethod(Integer.class, "doubleValue",
            double.class);
    private static final MethodDescriptor RADIX_VALUE_OF_METHOD = MethodDescriptor.ofMethod(Integer.class, "parseInt",
            int.class, String.class, int.class);
    private static final MethodDescriptor TO_CHARS_METHOD = MethodDescriptor.ofMethod(Character.class, "toChars", char[].class,
            int.class);
